...
-- ----------------------------
INSERT INTO `me_comment` (`content`, `create_date`, `article_id`, `author_id`, `parent_id`, `to_uid`, `level`)
VALUES
    ('你辛苦了', '2018-01-31 13:29:01', 1, 15, NULL, NULL, NULL),
    ('啦啦啦', '2018-01-31 16:12:31', 1, 1, NULL, NULL, NULL);
